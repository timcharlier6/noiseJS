...
document.getElementById('toggleWhite').addEventListener('change', function() {
  if (this.checked) {
    playNoise('white');
  } else {
    stopNoise('white');
...
document.getElementById('toggleBrown').addEventListener('change', function() {
  if (this.checked) {
    playNoise('brown');
  } else {
    stopNoise('brown');
...
document.getElementById('togglePink').addEventListener('change', function() {
  if (this.checked) {
    playNoise('pink');
  } else {
    stopNoise('pink');
